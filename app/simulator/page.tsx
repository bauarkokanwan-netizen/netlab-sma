...
const initialEdges: Edge[] = [
  { id: "e1", source: "pc-1", target: "sw-1", animated: true },
  { id: "e2", source: "sw-1", target: "pc-2", animated: true },
];
      ...
      <header className="border-b bg-white px-5 py-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-slate-500">Klik perangkat untuk edit IP. Tarik kabel dari titik perangkat ke perangkat lain.</p>
          </div>
      ...
      <section className="grid flex-1 grid-cols-1 gap-4 p-4 lg:grid-cols-[1fr_360px]">
        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-3xl bg-blue-50 p-5 text-sm text-slate-700">
            <b>Catatan guru:</b> Versi awal ini mengecek koneksi fisik dan subnet /24. Cocok untuk latihan LAN dasar kelas X/XI.
          </div>
        </aside>
      </section>
    </main>
